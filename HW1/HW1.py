...
class Solution():
    ...
    def readtrain(self):
        ...
        self.trainimgset,self.trainimglab=self.readfile(self.imgfile,self.labfile,55000)# 2 is the number of image I want to read
    ...
    def readtest(self):
        ...
        self.testimgset,self.testimglab=self.readfile(self.imgfile,self.labfile,3000)
        self.numTestImg=len(self.testimgset)
        print self.testimglab
        return
